...
public class homeFrame extends javax.swing.JFrame {
    ...
    DefaultTableModel table = new DefaultTableModel(new Object[]{"Client Name", "Address", "Email", "Contact", "Pet Name", "Species", "Breed", "Service/s", "Schedule", "Assistant", "Total Bill", "ID"}, 0);
    int editingRow = -1;
...
//        System.out.println("Home frame initialized without a specific role. Defaulting to: " + this.currentUserRole);
    ...
    public void addSelectedServices(String services) {
        // Assuming you have a JTextField named jTextFieldSelectedServices
        updateServicesTextfield.setText(services);
        // Optionally, you can also show a confirmation dialog
...
//     */
    ...
    private void initComponents() {
        ...
        updateServicesTextfield = new javax.swing.JTextField();
        ...
        jPanel6.add(classNameTextfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 40, 140, -1));

        jLabel4.setText("Address:");
        jPanel6.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, -1, -1));
        jPanel6.add(addressTextfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, 140, -1));
        jPanel6.add(contactTextfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 140, -1));
        ...
        jPanel6.add(emailTextfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 140, -1));
        ...
        jPanel7.add(petNameTextfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 110, 130, -1));
        jPanel7.add(speciesTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 130, -1));
        jPanel7.add(breedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 130, -1));
        ...
        jPanel9.add(assistantTextfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 112, 101, -1));
        jPanel9.add(jTextField13, new org.netbeans.lib.awtextra.AbsoluteConstraints(81, 112, 96, -1));

        jPanel16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        updateServicesTextfield.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateServicesTextfieldActionPerformed(evt);
            }
        });
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(updateServicesTextfield, javax.swing.GroupLayout.PREFERRED_SIZE, 367, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(updateServicesTextfield, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addContainerGap())
        );

        jPanel9.add(jPanel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 26, 400, 70));
...
//        settingsPanel.repaint();
        ...
        try {
            ...
            if (rowsAffected > 0) {
                ...
                model.addRow(new Object[]{
                    ...
                    selectedServices, schedule, assistant, totalBill, // ID can be added later if needed
                });
    ...
    private void updateServicesTextfieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateServicesTextfieldActionPerformed
//        servicesSelectionFrame selectionFrame = new servicesSelectionFrame(this);
//        selectionFrame.setVisible(true);
    }//GEN-LAST:event_updateServicesTextfieldActionPerformed
    private void updateServicesTextfield() {                                                        
        servicesSelectionFrame selectionFrame = new servicesSelectionFrame(this);
        selectionFrame.setVisible(true);
    }    
...
//        }
    ...
    private javax.swing.JTextField updateServicesTextfield;
